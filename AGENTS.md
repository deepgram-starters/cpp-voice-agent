...
C++ (Crow) demo app for Deepgram Voice Agent.
...
```
feat(cpp-voice-agent): add diarization support
fix(cpp-voice-agent): resolve WebSocket close handling
refactor(cpp-voice-agent): simplify session endpoint
